...
class SmartUnpickler(pickle.Unpickler):
    def load_short_binunicode(self):
        ...
        # Read ahead 100 bytes to look for \x94
...
try:
    ...
    # Manually update the dispatch dictionary to use our custom method
    unpickler.dispatch[140] = SmartUnpickler.load_short_binunicode
